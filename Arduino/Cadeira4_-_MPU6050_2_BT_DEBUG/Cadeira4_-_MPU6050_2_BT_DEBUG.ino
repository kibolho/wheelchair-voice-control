      ...
      case '2':
        {
          ...
          switch (param)
          {
            case 'f':
              ...
              goforward(30000,distanceBT*1000);
              break;
            case 'd':
              Serial.println("Direita");
             for(int a=2;a<(index-1);a++){
            ...
            case 'a':
              ...
              Serial.print("Param2 = ");
              Serial.println(distanceBT);
              gobackward(30000,distanceBT*1000);
              break;
            default: break; // do nothing
          } // switch (param)
        }
...
void goforward(int velocity, double distance) {
  ...
  if (valid1 && valid2) {
    ...
    Serial1.print("Encoder Erro");
  }
  while ((millis() - tempo) < distance || !(Serial1.available() > 0)) {
